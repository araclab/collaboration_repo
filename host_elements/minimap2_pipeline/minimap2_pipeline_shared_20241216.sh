...
# Sharing Modification - Edward (12/16/24)
# Commented out Step 2 on since this relies on the python scripting/processing.
# Step 1 is the minimap2 processing.
...
export target_element_genes='/lustre/groups/liu_price_lab/ehsung/2_GitHub/Development/ehsung/Food-epidemiology/minimap2_pipeline/databases/'
export reference_database='/lustre/groups/liu_price_lab/ehsung/2_GitHub/Development/ehsung/Food-epidemiology/minimap2_pipeline/databases/mlst_mappings/'
export python_scripts='/lustre/groups/liu_price_lab/ehsung/2_GitHub/Development/ehsung/Food-epidemiology/minimap2_pipeline/scripts/python/'
export perl_scripts='/lustre/groups/liu_price_lab/ehsung/2_GitHub/Development/ehsung/Food-epidemiology/minimap2_pipeline/scripts/perl/'

element_genes_fastaFile=20221101_elementgeneList.fasta
#  mlst_clades_File=MLST_Clades.csv



# User Inputs
reference_fasta_folder=$1 #Currently only .fasta files, you can modify the extension down below or create a regex
reference_fasta_HostLabels=$2
#  reference_ml_mapping=$3
...
# # Inputs: paf_files, host_labels, ml_mapping, mlst_clades, element_gene_names, output_name
# python $python_scripts/minimap2_output_processor.py $main_output/minimap2_paf_files/ $reference_fasta_HostLabels $reference_ml_mapping $reference_database/$mlst_clades_File $main_output/element_genes_fasta_Names.txt $output_naming
...
# mv ${output_naming}_*_blcm_READY.csv $main_output/minimap2_processed_files/blcm_ready
...
# mv $reference_ml_mapping $main_output/MiscFiles
